...
class genie {
  public:
    ...
    bool tx_tlm_gmsk__mode;
    bool rx__mode;
    bool _generating;
    bool tx_tlm_pcm_pm__mode;
    bool tx__mode;
    bool tx_tlm_qpsk__mode;
    bool rx_cmd_qpsk__mode;
    bool rx_cmd_pcm_psk_pm__mode;
    bool rx_cmd_bpsk__mode;
    bool tx_tlm_bpsk__mode;
    bool rx_cmd__mode;
    bool tx_tlm_pcm_psk_pm__mode;
    bool tx_tlm__mode;
    bool ranging__mode;
    bool ranging_turnaround__mode;
    genie();
    virtual void ext__tx_tlm_qpsk__off();
    virtual void ext__tx_tlm_pcm_pm__on();
    virtual void ext__tx_tlm__off();
    virtual void ext__tx_tlm_pcm_psk_pm__off();
    virtual void ext__tx_tlm_gmsk__on();
    virtual void ext__rx_cmd__off();
    virtual void ext__rx_cmd_bpsk__off();
    virtual void ext__rx_cmd__on();
    virtual void ext__tx_tlm__on();
    virtual void ext__tx_tlm_qpsk__on();
    virtual void ext__tx__on();
    virtual void ext__rx__on();
    virtual void ext__tx_tlm_gmsk__off();
    virtual void ext__rx_cmd_qpsk__on();
    virtual void __init();
    virtual void ext__rx_cmd_pcm_psk_pm__off();
    virtual void ext__rx_cmd_qpsk__off();
    virtual void ext__rx_cmd_bpsk__on();
    virtual void ext__tx_tlm_bpsk__off();
    virtual void ext__tx_tlm_bpsk__on();
    virtual void ext__tx_tlm_pcm_psk_pm__on();
    virtual void ext__rx_cmd_pcm_psk_pm__on();
    virtual void ext__tx_tlm_pcm_pm__off();
    virtual void ext__rx__off();
    virtual void ext__tx__off();
